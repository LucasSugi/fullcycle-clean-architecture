...
describe("E2E test for product", () => {
  ...
  it("should create a product", async () => {
    ...
    expect(response.body.name).toBe("ProductA");
  ...
  it("should list all product", async () => {
    ...
    expect(listResponseXML.text).toContain(`<name>ProductA</name>`);
    expect(listResponseXML.text).toContain(`<price>10</price>`);
    expect(listResponseXML.text).toContain(`</product>`);
    expect(listResponseXML.text).toContain(`<product>`);
    expect(listResponseXML.text).toContain(`<name>ProductB</name>`);
